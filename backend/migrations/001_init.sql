-- 001_init.sql: ClickHouse schema for PROCLUSTER
-- Run: clickhouse-client --multiquery < 001_init.sql

-- ============================================================
-- 1. ticker_config — управление параметрами тикеров
-- ============================================================
...
-- ============================================================
-- 2. clusters_futures — кластерные свечи (базовый уровень ×1)
-- ============================================================
...
-- ============================================================
-- 3. clusters_spot — кластерные свечи (базовый уровень ×1)
-- ============================================================
...
-- ============================================================
-- 4. dom_snapshots_futures — снапшоты стакана (под heatmap)
-- ============================================================
...
-- ============================================================
-- 5. dom_snapshots_spot — снапшоты стакана (под heatmap)
-- ============================================================
